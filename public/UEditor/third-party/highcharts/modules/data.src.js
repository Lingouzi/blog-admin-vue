...
(function (Highcharts) {
    ...
    const Data = function (dataOptions, chartOptions) {
	 ...
	 */
        getColumnDistribution: function () {
            ...
            const getValueCount = function (type) {
                return (Highcharts.seriesTypes[type || 'line'].prototype.pointArrayMap || [0]).length
            }
            const globalType = chartOptions && chartOptions.chart && chartOptions.chart.type
	 ...
	 */
        parseCSV: function () {
            ...
            const endRow = options.endRow || Number.MAX_VALUE
            const startColumn = options.startColumn || 0
            const endColumn = options.endColumn || Number.MAX_VALUE
            let lines
            let activeRowNo = 0
            ...
            if (csv) {
                ...
                each(lines, function (line, rowNo) {
                    ...
                    const isComment = trimmed.indexOf('#') === 0
	 ...
	 */
        parseGoogleSpreadsheet: function () {
            const self = this
            const options = this.options
            const googleSpreadsheetKey = options.googleSpreadsheetKey
            const columns = this.columns
            const startRow = options.startRow || 0
            const endRow = options.endRow || Number.MAX_VALUE
            const startColumn = options.startColumn || 0
